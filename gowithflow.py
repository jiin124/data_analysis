...
def number_of_cases(list_data):
    ...
    for i in range(len1):
        for j in range(0,len1):
            b.append(list_data[i]+list_data[j])
...
def main():
    list1=['a','b','c']
    print(number_of_cases(list1))
    decimal_number=100
    print(binary_converter(decimal_number))
    list_data=[9,2,3,4,1,5]
    print(find_smallest_value(list_data))
    price=40000
    print(discount_price(price))
    a=5
    b=6
    print(odd_even_check(a, b))
    list_data_a=[1,2,3,4,5,6]
    list_data_b=[1,2,3]
    print(comparison_list_size(list_data_a, list_data_b))
    element_value=5
    print(delete_a_list_element(list_data, element_value))
